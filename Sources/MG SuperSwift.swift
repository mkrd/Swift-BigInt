...
/*
	SuperSwift is a file that aims to improve the swift programming language. It adds missing
	functionality and convenient syntax to make the language more versatile.
*/
